...
# Validate version format (e.g., 1.0.7)
if ($Version -notmatch '^\d+\.\d+\.\d+$') {
    Write-Error "Invalid version format. Expected format: X.Y.Z (e.g., 1.0.7)"
    exit 1
}
...
Write-Host "`nGitHub Actions will now build and publish to Maven Central." -ForegroundColor Cyan
Write-Host "Check progress at: https://github.com/DenissLarka/druvu-lib-loader/actions" -ForegroundColor Cyan
